...
from unimorph_inflect.unimorph_inflect.myutil import simple_read_data
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d",
        "--models-dir",
        help="location of models files | default: ~/unimorph_inflect_resources",
        default=DEFAULT_MODEL_DIR,
    )
    parser.add_argument(
        "-l", "--language", help="language of text | default: en", default="eng"
    )
    parser.add_argument(
        "-t",
        "--testfile",
    ...
    # misc arguments
    parser.add_argument(
        "--force-download", help="force download of models", action="store_true"
    )
